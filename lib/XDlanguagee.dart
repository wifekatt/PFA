...
class XDlanguagee extends StatelessWidget {
  XDlanguagee({
    Key key,
  }) : super(key: key);
  @override
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(99.0, 18.0, 98.0, 51.0),
                    size: Size(296.0, 86.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(104.0, 18.0, 88.0, 51.0),
                    size: Size(296.0, 86.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
